...
import interfaces.validationinterfaces.ValaidationGate;
...
@NoArgsConstructor
public class Airport implements ShowAircraft, AddAircraft, SearchAircraft, DeleteAircraft, AssignGate, ValaidationGate {
